...
###############################
#
# Using mse as loss function, gamma = 0.90, epsilon = 1.0, learning_rate = 0.0001, 1000 EPISODES
#
###############################

learningRate = 0.0001

training_results_mse = training_NNQ_Agent(1000, 0.90, 1.0, learningRate, "mse", "_Alpha_" + str(learningRate) + "_mse.h5")
...
training_results_mse_out.to_csv("Alpha_" + str(learningRate) + "_training_results_mse_out.csv", index=False)

###############################
#
# Using mse as loss function, gamma = 0.90, epsilon = 1.0, learning_rate = 0.0001, 100 trails
#
###############################
...
testing_results_mse_out.to_csv("Alpha_" + str(learningRate) + "_testing_results_mse_out.csv", index=False)
