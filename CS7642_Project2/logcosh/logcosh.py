...
###############################
#
# Using logcosh as loss function, gamma = 0.90, epsilon = 1.0, learning_rate = 0.001, 1000 EPISODES
#
###############################

discount = 0.90

training_results_mse = training_NNQ_Agent(1000, discount, 1.0, 0.001, "logcosh", "_Gamma_" + str(discount) + "_logcosh.h5")
...
training_results_mse_out.to_csv("logcosh_training_results_mse_out.csv", index=False)

###############################
#
# Using logcosh as loss function, gamma = 0.90, epsilon = 1.0, learning_rate = 0.001, 100 trails
#
###############################

testing_results_mse = testing_NNQ_Agent(100, discount, 1.0, 0.001, "logcosh", training_results_mse[5])
...
testing_results_mse_out.to_csv("logcosh_testing_results_mse_out.csv", index=False)
