...
class NNQ_Agent:
    ...
    def _build_model(self, loss_fuction):
        model = Sequential()
        model.add(Dense(80, input_dim=self.state_dim, activation='relu'))
...
###############################
#
# Using mse as loss function, gamma = 0.99, epsilon = 1.0, learning_rate = 0.0001, 1000 EPISODES
#
###############################

learningRate = 0.0001

training_results_mse = training_NNQ_Agent(1500, 0.99, 1.0, learningRate, "mse", "_final_model_mse.h5")
...
training_results_mse_out.to_csv("final_model_training_results_mse_out.csv", index=False)

###############################
#
# Using mse as loss function, gamma = 0.99, epsilon = 1.0, learning_rate = 0.0001, 100 trails
#
###############################

testing_results_mse = testing_NNQ_Agent(100, 0.99, 1.0, learningRate, "mse", training_results_mse[5])
...
testing_results_mse_out.to_csv("final_model_testing_results_mse_out.csv", index=False)
